...
import { formatCurrency, calcGST, applyTradeDiscount, INDIA_STATES } from '@/lib/utils'
...
type Product  = { id: string; name: string; price: number; stock: number; hsnCode?: string | null; gstRate: number }
type LineItem  = {
  productId: string
  name: string
  quantity: number
                  ...
                  >
                    ...
                    <div className="col-span-4">
                      <select
                        ...
                        onChange={e => handleProductSelect(rowIdx, e.target.value)}
